// https://www.emanueleferonato.com/2015/08/27/learn-how-phaser-manages-draggable-objects-by-making-the-html5-engine-behind-rush-hour-game/
...
const carColors = ['0xff0000', '0x00ff00', '0x0000ff', '0xffff00', '0x00ffff', '0xff00ff'];
...
playGame.prototype = {
  ...
  create() {
    ...
    for (let i = 0; i < carsArray.length; i++) {
      ...
      const carSprite = game.add.sprite(tileSize * car.col + tileSize * car.dir, tileSize * car.row, car.spr);
